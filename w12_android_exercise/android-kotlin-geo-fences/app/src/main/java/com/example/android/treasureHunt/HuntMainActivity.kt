...
class HuntMainActivity : AppCompatActivity() {
    ...
    // For devices running Android Q (API 29) or later, you will have 
    // to ask for an additional background location permission.
 ...
 */
    ...
    override fun onRequestPermissionsResult(
        ...
        // and the BACKGROUND_LOCATION_PERMISSION_INDEX is denied, it means that the device 
        // is running Q (API 29) or above and that background permissions were denied.
        if (
    ...
    private fun requestForegroundAndBackgroundLocationPermissions() {
        // If the permissions have already been granted, you don't need 
        // to ask again, so you can return out of the method.
        if (foregroundAndBackgroundLocationPermissionApproved())
            return
        ...
        // Initially, add ACCESS_FINE_LOCATION since that is needed by all API levels.
        var permissionsArray = arrayOf(Manifest.permission.ACCESS_FINE_LOCATION)

        // This code is different if the device is running Q (API 29) or later and 
        // determines whether you need to check for one permission (fine location) or 
        // multiple permissions (fine and background location) when the user returns 
        // from the permission request screen.
        val resultCode = when {
            runningQOrLater -> {
        ...
        // Finally, request permissions passing in the current activity, the permissions 
